...
<div class="container">
    <div class="leftsidebar_box">
        <div class="line"></div>
        <dl class="system_log">
                <dt onClick="changeImage()" class="a">用户管理<img class="pic" src="../images/select_xl01.png"></dt>
                <dd class="first_dd"><a href="${pageContext.request.contextPath}/admin/UserAction_addUser" target="main">增加用户</a></dd>
                <dd><a href="${pageContext.request.contextPath}/admin/UserAction_userList" target="main">管理用户</a></dd>
            </dl>
